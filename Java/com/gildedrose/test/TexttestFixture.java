...
public class TexttestFixture {
    public static void main(String[] args) {
        ...
        List<ItemWithType> items = new ArrayList<ItemWithType>();
                ...
                items.add(new ItemWithType("Sulfuras, Hand of Ragnaros", ItemType.LEGENDARY, 0, 80)); //
                items.add(new ItemWithType("Sulfuras, Hand of Ragnaros", ItemType.LEGENDARY, -1, 80));
                ...
                items.add(new ItemWithType("Conjured Mana Cake", ItemType.CONJURED, 3, 5));
